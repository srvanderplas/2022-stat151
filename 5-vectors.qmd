...
![Venn Diagram of Set A and Set B](images/SetA and SetB.svg)
Suppose that we set the convention that ![Shaded regions are TRUE, unshaded regions are FALSE](images/TrueFalse.svg).

We can then illustrate DeMorgan's first law as follows:

![A venn diagram illustration of De Morgan's laws showing that the region that is outside of the union of A OR B (aka NOT (A OR B)) is the same as the region that is outside of (NOT A) and (NOT B)](images/DeMorgan1.svg)


And similarly, DeMorgan's second law: 

![A venn diagram illustration of De Morgan's laws showing that the region that is outside of the union of A AND B (aka NOT (A AND B)) is the same as the region that is outside of (NOT A) OR (NOT B)](images/DeMorgan2.svg)
...
![Program flow diagram outline of a simple if/else statement](images/flow-chart1.svg)
...
![The control flow diagram for the code in the previous example](images/tax-brackets.svg)
</details>
