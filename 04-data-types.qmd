...
We're also not going to talk about how to create our own functions just yet. Instead, I'm going to show you how to _use_ functions. 

It may be helpful at this point to print out the [R reference card](files/Short-refcard.pdf)^[From https://cran.r-project.org/doc/contrib/Short-refcard.pdf] and the [Python reference card](files/Python3_reference_cheat_sheet.pdf)^[From http://sixthresearcher.com/wp-content/uploads/2016/12/Python3_reference_cheat_sheet.pdf]. These cheat sheets contain useful functions for a variety of tasks in each language. 
