...
We can have vectors of any data type and length we want[^vectors-1]: ![vectors of different data types](images/lego-set-of-vectors.png)
...
Extra challenge solution (python)
...
Program Flow Maps of chained conditional statements
...
Iterating along a list in python
...
Infinite loop protection in python
